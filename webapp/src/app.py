...
def predict():
    ...
    explanation = {0: "Your title might get a below-median rating. Don’t panic. Take a closer look at the “top features” shown below the score. Consider tweaking features with the most positive and negtive \"contribution\" for a better performance. 😉",
                    1: "We expect your title to get an above-median rating. Congratulations! 🤩 See how you can improve your probability of being above-averge by tweaking features with the most positive and negtive \"contribution\"."}
